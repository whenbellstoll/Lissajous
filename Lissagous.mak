...
VERSION = BCB.05.00
# ---------------------------------------------------------------------------
PROJECT = "Lissagous.exe"
OBJFILES = StateMachineFun.obj GameNodeFun.obj LoadActorsFun.obj MyGame.obj \
    GameFunctions.obj LocalDataFun.obj
RESFILES = "fun.res"
MAINSOURCE = "Lissagous.bpf"
RESDEPEN = $(RESFILES)
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
...
INCLUDEPATH = "C:\Game Projects\Lissajous Curves";$(BCB)\include;"C:\Program Files (x86)\DigiPen\FunEditor1.5\Library\FunInclude"
LIBPATH = "C:\Game Projects\Lissajous Curves";$(BCB)\lib;$(BCB)\Lib\Psdk;"C:\Program Files (x86)\DigiPen\FunEditor1.5\Library\FunLibBC"
WARNINGS= -w-par
PATHCPP = .;
PATHASM = .;
PATHPAS = .;
